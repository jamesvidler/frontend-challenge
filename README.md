...
## The Challenge
Build an SPA (Single-Page-Application) that allows website visitors to submit a comment and view a listing of **Comments** using a sample  [Comments API](http://comments-api.azurewebsite.net/swagger/). 

## Requirements
1. The homepage should have a listing of **Comments** retreived from the [API](http://comments-api.azurewebsite.net/swagger/).
2. The homepage should have a link that allows users to submit a new **Comment** using the [API](http://comments-api.azurewebsite.net/swagger/). This can be either to another page or trigger a UI interaction on the current page.
...
- Must call the sample [API](http://comments-api.azurewebsite.net/swagger/).
